...
logging.basicConfig(level=logging.INFO, format='%(asctime)s - %(name)s  - %(levelname)s - %(message)s', handlers=[logging.FileHandler(f'{'Access_token_log'}'), logging.StreamHandler(sys.stdout)])
