...
@shared_task(bind=True, name="Yoko Mitsumori Soufu")
def main(self: Task):
    exe_path = Path(__file__).resolve().parents[2] / "robot" / "YokoMitsumoriSoufu" / "「横浜」見積書送付_V2.3.exe"
    ...
    result = minio.fput_object(
        ...
        object_name=f"YokoMitsumoriSoufu/{self.request.id}/ProgressReports.zip",
